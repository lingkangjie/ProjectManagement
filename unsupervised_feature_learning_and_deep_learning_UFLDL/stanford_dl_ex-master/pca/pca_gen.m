...
% covar_rd = xPCAWhite_rd * xPCAWhite_rd' / size(xPCAWhite_rd,2);
...
% figure('name','ZCA whitened images with dimension reduction');
% display_network(xZCAWhite_rd(:,randsel));
