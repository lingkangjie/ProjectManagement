...
for imageNum = 1:numImages
  for filterNum = 1:numFilters
    ...
    %%% YOUR CODE HERE %%%
    %valid meaning that the entire 8x8 patch is contained within 
    % the image; this is as opposed to a full convolution, which allows 
    % the patch to extend outside the image, with the area outside the 
    % image assumed to be 0
